...
public class MR_goldenCarott : MonoBehaviour
{
    Mesh mesh;
    Mesh mesh2;
    GameObject karotte;
    ...
    void Start()
    {
        ...
        //goldene Karotte als Ziel
        createCarott(155.96f, 13.67f, 317.03f);
    ...
    void createCarott(float x, float y, float z){
        ...
        empty = new GameObject("GoldenCarrott");
        ...
        empty.transform.localScale = new Vector3(0.5f,0.5f,0.5f); //Größe geändert 
        empty.transform.Rotate(0, 0, -180);
        ...
        var audioClip = Resources.Load<AudioClip>("Sounds/win");
        audioSource.clip = audioClip;
        //audioSource.volume = 0.1f;

        empty.AddComponent<AM_end>();
    }
