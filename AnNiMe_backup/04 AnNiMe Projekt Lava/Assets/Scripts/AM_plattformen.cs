...
public class AM_plattformen : MonoBehaviour
{
   ...
   // AM_charHolder charHalter;
    ...
    void Start()
    {
        ...
        Plattform2 = Instantiate(goPlattform, new Vector3(315, 3.8f, 21), goPlattform.transform.rotation);
        Plattform2.name = "Plattform2";
        Plattform3 = Instantiate(goPlattform, new Vector3(306, 4.3f, 17), goPlattform.transform.rotation);
    ...
    void floatingup()
    {
        ...
        Plattform2.transform.position = Vector3.Lerp(Plattform2.transform.position, new Vector3(315 + randX2, 3.8f + randY2, 21 + randZ2), Time.deltaTime * randDelta);
        Plattform3.transform.position = Vector3.Lerp(Plattform3.transform.position, new Vector3(306 + randX3, 4.3f + randY3, 17 + randZ3), Time.deltaTime * randDelta);
        Plattform4.transform.position = Vector3.Lerp(Plattform4.transform.position, new Vector3(297 + randX4, 4.4f + randY4, 20 + randZ4), Time.deltaTime * randDelta);
        Plattform5.transform.position = Vector3.Lerp(Plattform5.transform.position, new Vector3(292 + randX5, 4.8f + randY5, 23 + randZ5), Time.deltaTime * randDelta);
    }

    void floatingdown()
    {
        goPlattform.transform.position = Vector3.Lerp(goPlattform.transform.position, new Vector3(322, 3, 18), Time.deltaTime * .7f);
        Plattform2.transform.position = Vector3.Lerp(Plattform2.transform.position, new Vector3(315, 3.8f, 21), Time.deltaTime * .7f);
        Plattform3.transform.position = Vector3.Lerp(Plattform3.transform.position, new Vector3(306, 4.3f, 17), Time.deltaTime * .7f);
